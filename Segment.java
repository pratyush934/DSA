public class Segment {
    ...
    public static void upadateUtil(int i, int si, int sj, int idx, int diff) {
        if(idx > sj || idx < si) {
            return;
        }
        ...
        if(si != sj) {
            int mid = (si + sj)/2;
            upadateUtil(2*i+1, si, mid, idx, diff); /* left */
            upadateUtil(2*i+2, mid+1, sj, idx, diff);/* right */
        }
    }
    ...
    public static void update(int arr[], int idx, int newVal) {
        ...
        upadateUtil(0, 0, n-1, idx, diff); /* segment tree updation */
    }
    ...
    public static void update1Util(int i, int si, int sj, int idx, int newVal) {
        ...
        if(si != sj) {
            int mid = (si + sj)/2;
            update1Util(2*i+1, si, mid, idx, newVal);
            update1Util(2*i+2, mid+1, sj, idx, newVal);
        }
